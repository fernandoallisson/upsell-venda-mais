...
import { uploadImage, uploadVideo } from '../../../../lib/services/uploads/uploads.service'
    ...
    <CollapsibleSection number={2} title="Conteúdo" defaultOpen={true}>
      <div className="space-y-4">
        ...
        <FileUploadField
          ...
          accept="image/*"
          icon={<Image className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" />}
        ...
        <FileUploadField
          ...
          accept="video/*"
          icon={<Video className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" />}
