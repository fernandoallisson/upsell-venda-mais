  ...
  return (
    ...
    >
      ...
      <div style={{ padding: spacing.padding }}>
        ...
        >
          {form.headline || <span className="text-slate-300">Titulo da oferta</span>}
        </p>
        ...
        >
          {form.description || <span className="text-slate-300">Descricao da oferta...</span>}
        </p>
        ...
        <div style={{ marginTop: spacing.gap }}>
          ...
          {layout.showDismiss && (
            ...
            >
              {layout.dismissText || 'Nao, obrigado'}
            </button>
          )}
        </div>
      </div>
    ...
    >
      ...
      <div style={{ padding: spacing.padding, flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 8 }}>
        <p style={{ color: colors.text, fontSize: typography.headlineSize, fontWeight: typography.headlineWeight, lineHeight: 1.3 }}>
          {form.headline || <span className="text-slate-300">Titulo</span>}
        </p>
        <p style={{ color: colors.text, fontSize: typography.descriptionSize, opacity: 0.7, lineHeight: 1.4 }}>
          {form.description || <span className="text-slate-300">Descricao...</span>}
        </p>
        <button
          type="button"
          style={{
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl bg-slate-900/60 p-6">
        <p className="mb-3 text-center text-xs font-semibold text-white/60">Preview Modal</p>
